insert into publications values(default, 'TheSun', null, 'Newspaper', 'Daily', 1.99);
insert into publications values(default, 'EE', null, 'Magazine', 'Weekly', 3.50);
insert into publications values(default, 'The Divine Comedy', 'Dante Alighieri', 'Book', 'Once', 1.99);
